...
[![Test](https://img.shields.io/github/actions/workflow/status/smashedr/web-enhancer/test.yaml?logo=github&logoColor=white&label=test)](https://github.com/smashedr/web-enhancer/actions/workflows/test.yaml)
...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=smashedr_web-enhancer&metric=alert_status&label=quality)](https://sonarcloud.io/summary/overall?id=smashedr_web-enhancer)
